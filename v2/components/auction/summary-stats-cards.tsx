      ...
      <Card>
        ...
        <CardContent className="space-y-1.5">
          ...
          <StatRow
            ...
            color={myTeams.expectedProfit >= 0 ? 'text-green-600' : 'text-red-600'}
          />
          <StatRow
            label="ROI"
            value={`${myTeams.roi.toFixed(1)}%`}
            color={myTeams.roi >= 0 ? 'text-green-600' : 'text-red-600'}
          />
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="space-y-1.5">
          ...
          <StatRow
            ...
            color={opponents.expectedProfit >= 0 ? 'text-green-600' : 'text-red-600'}
          />
          <StatRow
            label="ROI"
            value={`${opponents.roi.toFixed(1)}%`}
            color={opponents.roi >= 0 ? 'text-green-600' : 'text-red-600'}
          />
        </CardContent>
      </Card>
